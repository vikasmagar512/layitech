...
// nor polyfill, then a plain number is used for performance.
    ...
    ReactElement.cloneElement = function (element, config, children) {
        ...
        // transpiler, and the original.html source is probably a better indicator of the
        // true owner.
...
// not extract events. See #3639.
    ...
    function getPooledWarningPropertyDefinition(propName, getVal) {
        ...
        function warn(action, result) {
            ...
            "development" !== 'production' ? warning(warningCondition, 'This synthetic event is reused for performance reasons. If you\'re seeing this, ' + 'you\'re %s `%s` on a released/nullified synthetic event. %s. ' + 'If you must keep the original.html synthetic event around, use event.persist(). ' + 'See https://fb.me/react-event-pooling for more information.', action, propName, result) : void 0;
        }
    }
