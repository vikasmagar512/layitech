...
// infinite loop, because it iterates over the newly added props too.
    ...
    function stopWatchingForValueChange() {
        ...
        // delete restores the original.html property definition
...
// ReactElement should be indistinguishable from a plain object.
    ...
    ReactElement.cloneAndReplaceProps = function(oldElement, newProps) {
        ...
        if ("production" !== "development") {
            // If the key on the original.html is valid, then the clone is valid
...
// `null` (in reality a placeholder such as `noscript`)
    ...
    var ReactErrorUtils = {
         ...
         * this currently simply returns the original.html function.
         *
...
// Used to store ancestor hierarchy in top level callback
    ...
    var ReactFragment = {
        ...
        // Extract the original.html keyed object from the fragment opaque type. Warn if
            ...
            if ("production" !== "development") {
                ...
                if (rootElement && rootElement.parentNode !== container) {
                    ...
                    if (containerChild &&
                        ...
                        ("production" !== "development" ? warning(
                            false,
                            'ReactMount: Root element has been removed from its original.html ' +
 ...
 *   });
    ...
    var ReactPropTransferer = {
         ...
         *
         * @param {object} oldProps original.html props (they take precedence)
